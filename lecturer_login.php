...
if (isset($_POST['btnLogin'])) {
    $lecturerID = mysqli_real_escape_string($connLecturer, $_POST['lecturerID']);

    $sql = "SELECT * FROM user WHERE USER_ID = '$lecturerID'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $_SESSION['lecturerID'] = $row['USER_ID'];
        $_SESSION['lecturerName'] = $row['USER_NAME'];
...
<body>
    <div class="login-box">
        ...
        <p>Enter your lecturer ID</p>

        <?php if ($error != "") echo "<div class='error'>$error</div>"; ?>

        <form method="POST">
            <input type="text" name="lecturerID" placeholder="Lecturer ID / USER_ID" required>
